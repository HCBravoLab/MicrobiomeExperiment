...
mbF <- MicrobiomeFeatures(taxa_table, 
                          phyloTree = mock_mgF@refDbTree, 
                          seq = mock_mgF@refDbSeq, 
                          metadata = mock_mgF@metadata)
...
# data(newMouseData)
# 
# mouse_counts <- MRcounts(newMouseData)
# mouse_taxTab <- fData(newMouseData)
# 
# tree <- TreeIndex(mouse_taxTab)
# mbiome <- TreeSummarizedExperiment(SimpleList(counts=mouse_counts),
#                                    rowData=tree)
# #####################
...
tax_table(PHYExp)
# MicrobiomeExperiment
taxTable(MBExp) # returns two additional columns: 'allFeatures' and 'otu_index'
```
